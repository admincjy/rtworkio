										...
										<c:when test="${r"${not empty varList}"}">
											...
											<#list fieldList as var>
												...
												<#else>
													...
													<td>
														<a title="修改" onclick="edit('${r"${var."}${objectNameUpper}_ID${r"}"}');" style="cursor:pointer;"><i class="feather icon-edit-2"></i></a>
					                 					<a title="删除" onclick="del('${r"${var."}${objectNameUpper}_ID${r"}"}');" style="cursor:pointer;"><i class="feather icon-x"></i></a>
													</td>
												</tr>
