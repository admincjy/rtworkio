                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
								...
								<form action="distributedmx/${msg }" name="Form" id="Form" method="post" style="width: 100%;">
									<input type="hidden" name="DISTRIBUTEDMX_ID" id="DISTRIBUTEDMX_ID" value="${pd.DISTRIBUTEDMX_ID}"/>
						            ...
						            <!--<div class="input-group input-group-sm mb-3" style="margin-top: -10px;">
	                                    ...
	                                    <input type="text" class="form-control" name="CARTETIME" id="CARTETIME" value="${pd.CARTETIME}" maxlength="255" placeholder="这里输入创建时间" title="创建时间">
	                                </div>-->
