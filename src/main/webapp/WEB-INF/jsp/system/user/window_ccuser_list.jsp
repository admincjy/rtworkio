                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
								          ...
								          <form action="user/listCCUsersForWindow" method="post" name="Form" id="Form">
											<!-- 检索条件  -->
											...
											<table>
												<tr>
													<td>
								                        <div class="input-group input-group-sm mb-3">
                                                        	<input class="form-control" id="NAMES" type="text" name="NAMES" value="${pd.NAMES }" placeholder="抄送人" style="width: 425px;" disabled="disabled"/>
                                                    	</div>
													</td>
													<td style="vertical-align:top;padding-left:5px;">
															<a class="btn btn-light btn-sm" onclick="commint();" style="width: 23px;height:30px;margin-top:1px;" title="提交">
																<i style="margin-top:-3px;margin-left: -6px;"  class="feather icon-check"></i>
															</a>
															<a class="btn btn-light btn-sm" onclick="del();" style="width: 23px;height:30px;margin-top:1px;" title="提交">
																<i style="margin-top:-3px;margin-left: -6px;"  class="feather icon-x"></i>
															</a>
													</td>
												</tr>
											</table>
													 ...
													 <c:choose>
														<c:when test="${not empty userList}">
									                 	 <c:forEach items="${userList}" var="user" varStatus="vs">
											                 <tr ondblclick="setUser('${user.NAME}','${vs.index}')" style="cursor:pointer;">
											                     <td>
																  	<div class="checkbox d-inline">
		                                                            	<input type="checkbox" id="zcheckbox${vs.index }" name='ids' value="">
