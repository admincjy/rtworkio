										...
										<tr height="35">
											<td style="width:50px;">角色组:</td>
												...
												<c:forEach items="${roleList}" var="role" varStatus="vs">
													<td>
														<a class="btn btn-${pd.ROLE_ID == role.ROLE_ID?"secondary":"light"} btn-sm"	 href="buttonrights/list?ROLE_ID=${role.ROLE_ID }" ><i class="feather icon-users"></i>${role.ROLE_NAME }</a>
													</td>
												...
												<tr>
													...
													<shiro:hasPermission name="buttonrights:edit">
														...
														<c:forEach items="${buttonlist}" var="fhbutton" varStatus="vsb">
															<th style="text-align: center;">${fhbutton.NAME }</th>
														</c:forEach>
													</shiro:hasPermission>
												</tr>
												</thead>
											...
											<table style="width:100%;margin-top:15px;">
												<tr>
													<td style="vertical-align:top;">
														<a class="btn btn-light btn-sm" onclick="window.location.href='<%=basePath%>buttonrights/list?type=2&ROLE_ID=${pd.ROLE_ID }';">切换视图</a>
													</td>
												</tr>
											</table>
										</div>
