															...
															<c:when test="${not empty varList}">
																<c:forEach items="${varList}" var="var" varStatus="vs">
																	<tr>
																		<td>
																		  	<div class="checkbox d-inline">
				                                                            	<input type="checkbox" id="zcheckbox${vs.index }" name='ids' value="${var.HISMSG_ID}">
																		...
																		<td>${var.CONTENT}</td>
																		<td>
																			<a title="删除" onclick="del('${var.HISMSG_ID }');" style="cursor:pointer;"><i class="feather icon-x"></i></a>
																		</td>
																	</tr>
