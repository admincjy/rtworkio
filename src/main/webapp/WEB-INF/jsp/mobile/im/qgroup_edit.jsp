                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
									...
									<form action="mobqgroup/${msg }" name="Form" id="Form" method="post" enctype="multipart/form-data" style="width: 100%;">
										...
										<div id="showform" style="padding-top: 0px;">
								            ...
								            <div class="input-group input-group-sm mb-3" style="margin-top: -10px;">
			                                    ...
			                                    <input  style="max-width: 252px;" type="text" class="form-control" name="NAME" id="NAME" value="${pd.NAME }" maxlength="32" placeholder="这里输入群名称" title="群名称">
		                                 	</div>
