															...
															<c:when test="${not empty varList}">
										                 	 <c:forEach items="${varList}" var="var" varStatus="vs">
												                 <tr>
																	 <td>
																	  	<div class="checkbox d-inline">
			                                                            	<input type="checkbox" id="zcheckbox${vs.index }" name='ids' value="${var.CREATECODE_ID}">
												                     ...
												                     <td>
												                     	<shiro:hasPermission name="createCode:edit"><a title="编辑" onclick="productCode('${var.CREATECODE_ID}');" style="cursor:pointer;"><i class="feather icon-edit-2"></i></a></shiro:hasPermission>
												                     	<shiro:hasPermission name="createCode:del"><a title="删除" onclick="del('${var.CREATECODE_ID}');" style="cursor:pointer;"><i class="feather icon-x"></i></a></shiro:hasPermission>
												                     </td>
												                 </tr>
											                 </c:forEach>
											                </c:when>
										             ...
										             <table style="width:100%;margin-top:15px;">
														<tr>
															<td style="vertical-align:top;">
																<shiro:hasPermission name="createCode:add"><a class="btn btn-light btn-sm" onclick="productCode('add');">启动生成器</a></shiro:hasPermission>
																<shiro:hasPermission name="createCode:del"><a class="btn btn-light btn-sm" onclick="makeAll('确定要删除选中的数据吗?');">删除</a></shiro:hasPermission>
															</td>
