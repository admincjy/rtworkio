	...
	function appendC(value){
		...
		$("#fields").append(
			...
			'<td>'+
				...
				'<a title="编辑" onclick="editField(\''+value+'\',\''+index+'\')" style="cursor:pointer;"><i class="feather icon-edit-2"></i></a></a>&nbsp;'+
				'<a title="删除" onclick="removeField(\''+index+'\')" style="cursor:pointer;"><i class="feather icon-x"></i></a>'+
			'</td>'+
			'</tr>'
		);
		index++;
