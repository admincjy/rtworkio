 ...
 */
@Controller
@RequestMapping("/mobilefhsms")
public class MobFhsmsController extends AcStartController {
	...
	public String list(Page page, Model model) throws Exception{
		...
		if(!"2".equals(pd.getString("TYPE"))){					//1：收信箱 2：发信箱
			pd.put("TYPE", 1);
			return "mobile/fhsms/fhsms_s_list";
		}else{
			return "mobile/fhsms/fhsms_f_list";
		}
	}
