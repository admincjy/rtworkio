...
public class Dictionaries {
	...
	private String text;
	private List<Dictionaries> nodes;
	...
	public List<Dictionaries> getNodes() {
		return nodes;
	}
	public void setNodes(List<Dictionaries> nodes) {
		this.nodes = nodes;
	}
	...
	public String toString() {
		return "Dictionaries [NAME=" + NAME + ", NAME_EN=" + NAME_EN + ", BIANMA=" + BIANMA + ", ORDER_BY=" + ORDER_BY
				+ ", PARENT_ID=" + PARENT_ID + ", BZ=" + BZ + ", TBSNAME=" + TBSNAME + ", DICTIONARIES_ID="
				+ DICTIONARIES_ID + ", target=" + target + ", dict=" + dict + ", subDict=" + subDict + ", hasDict="
				+ hasDict + ", treeurl=" + treeurl + ", text=" + text + ", nodes=" + nodes + "]";
	}
